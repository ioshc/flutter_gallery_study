...
class Tab1ItemPage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => new _Tab1ItemPageState();
}

class _Tab1ItemPageState extends State<Tab1ItemPage> {
  @override
  void initState() {
    super.initState();
          ...
          children: <Widget>[
            ...
            new SizedBox(
              ...
              child: new ListView.builder(
                ...
                itemCount: relatedColors.length,
                itemExtent: 160.0,
