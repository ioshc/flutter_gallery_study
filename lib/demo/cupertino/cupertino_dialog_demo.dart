...
class CupertinoDialogsDemo extends StatefulWidget {
  static const String routeName = '/cupertino/dialog';

  @override
  _CupertinoDialogsDemoState createState() => new _CupertinoDialogsDemoState();
}

class _CupertinoDialogsDemoState extends State<CupertinoDialogsDemo> {
