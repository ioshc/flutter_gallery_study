...
class BottomAppBarDemo extends StatefulWidget {
  static const String routeName = 'material/bottom-app-bar';
...
class _BottomAppBarDemoState extends State<BottomAppBarDemo> {
  ...
  static const _ChoiceValue<FloatingActionButtonLocation> kFabEndDocked =
      const _ChoiceValue<FloatingActionButtonLocation>(
    title: 'Attached - End',
      ...
      body: new SafeArea(
        ...
        child: new ListView(
          ...
          children: <Widget>[
            ...
            new _RadioItem<bool>(
                kShowNotchTrue, _showNotch, _onShowNotchChanged),
            new _RadioItem<bool>(
                kShowNotchFalse, _showNotch, _onShowNotchChanged),
            const Divider(),
            const _Heading('FAB Position'),
            new _RadioItem<FloatingActionButtonLocation>(
