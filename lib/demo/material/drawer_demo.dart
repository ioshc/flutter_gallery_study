...
class _DrawerDemoState extends State<DrawerDemo> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _drawerDetailsPosition = new Tween(
        ...
        child: new InkWell(
          ...
          child: new Column(
            ...
            children: <Widget>[
              ...
              const Text('Tap here to open the drawer'),
            ],
          ),
        ),
      ),
                      ...
                      children: <Widget>[
                        new FadeTransition(
                          ...
                          child: new Column(
                            ...
                            children: _drawerContents.map((String label) {
                              return new ListTile(
                                leading:
                                    new CircleAvatar(child: new Text(label)),
                                title: new Text('Drawer item ' + label),
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return new AlertDialog(
          content: Text('Account switching not implemented'),
          actions: <Widget>[
            new FlatButton(
              onPressed: () {
