...
class _TabsFabDemoState extends State<TabsFabDemo>
      ...
      return new Container(
        ...
        child: new Card(
          child: new Center(
            child: new Text(
              page.label,
              style: new TextStyle(color: page.labelColor, fontSize: 32.0),
  ...
  FloatingActionButton buildFloatingActionButton(_Page page) {
    ...
    return new Scaffold(
      ...
      appBar: new AppBar(
        ...
        bottom: new TabBar(
          ...
          isScrollable: true,
          tabs: _allPages
              .map((_Page page) => Tab(text: page.label.toUpperCase()))
              .toList(),
        ),
        actions: <Widget>[
          new IconButton(
