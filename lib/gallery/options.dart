...
class _OptionsItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MergeSemantics(
      child: new Container(
        constraints: new BoxConstraints(minHeight: _kItemHeight),
...
class _BooleanItem extends StatelessWidget {
  _BooleanItem(this.title, this.value, this.onChanged);
...
class _ThemeItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return new _BooleanItem('Dark Theme', (options.theme == kDarkGalleryTheme),
        (bool value) {
      onOptionsChanged(
        options.copyWith(
    ...
    return new _OptionsItem(
      child: new Row(
        children: <Widget>[
          ...
          new PopupMenuButton(
            padding: new EdgeInsetsDirectional.only(end: 16.0),
